...
public class LikeController {
    ...
    @PostMapping("/like") //좋아요 저장시에 id 중복검사 후 중복시 예외처리 추가 예정
    ...
    public ResponseEntity<String> cancelLike(@PathVariable Long postId, @PathVariable Long userId){
        likeService.deleteLike(LikeRequestDTO.builder().postId(postId).userId(userId).build());
