...
//            } 예외처리 로직 -> 서비스 레이어로 옮김
        ...
        public ResponseEntity<Boolean> verifyPaymentAmount(@RequestBody PaymentDTO paymentDTO) {
            boolean paymentVerified = orderService.verifyPaymentAmount(paymentDTO);
